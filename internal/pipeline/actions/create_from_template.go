...
func (c CreateFromTemplate) Plan(ctx *context.Context) ([]pipeline.Patch, error) {
	switch c.Template {
	case "app":
...
func createApp(ctx *context.Context) ([]pipeline.Patch, error) {
...
func createModule(ctx *context.Context) ([]pipeline.Patch, error) {
	return pipeline.New().Add(
